<template>
  <form @submit.prevent="submitForm">
    ...
    <p v-if="!formIsValid">Please fix the above errorsand submit again.</p>
...
export default {
  ...
  methods: {
    clearValidaty(input) {
      this[input].isValid = true; // input = firstName or lastName ... 
    },
    validateForm() {
