<template>
  <div>
    <base-dialog :show="!!error" title="An error occurred!" @close="handeleError">
      <p>{{ error }}</p>
    </base-dialog>
    <section>
    ...
    <section>
      <base-card>
        ...
        <ul v-else-if="hasCoaches">
          <coach-item v-for="coach in filtredCoaches" :key="coach.id" :id="coach.id" :firstName="coach.firstName"
